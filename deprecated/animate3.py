...
ax1.set(xlim=[0, 60], ylim=[0, 20])
ax1.set_aspect('equal')
ax1.legend()

xdir, ydir = test.line_projection(ans[0,0], ans[0,1], ans[0,2], d=10)
...
ax3.set_title('timedelay theoretical derivative d')
...
def update(frame):
	...
	xdir, ydir = test.line_projection(ans[frame,0], ans[frame,1], ans[frame,2], d=10)
...
ani.save('timedelay_theoretical_no_noise_yes_correction_alpha=0.5.mp4', writer=writervideo) 
plt.show()
